...
#define GL_COMPRESSED_RGB_S3TC_DXT1_EXT 0x000083F0
#define GL_COMPRESSED_RGBA_S3TC_DXT1_EXT 0x000083F1
#define GL_COMPRESSED_RGBA_S3TC_DXT3_EXT 0x000083F2
#define GL_COMPRESSED_RGBA_S3TC_DXT5_EXT 0x000083F3
...
typedef void (*PROC_glCullFace)(GLenum mode);
typedef void (*PROC_glFrontFace)(GLenum mode);
typedef void (*PROC_glHint)(GLenum target, GLenum mode);
typedef void (*PROC_glLineWidth)(GLfloat width);
typedef void (*PROC_glPointSize)(GLfloat size);
typedef void (*PROC_glPolygonMode)(GLenum face, GLenum mode);
typedef void (*PROC_glScissor)(GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (*PROC_glTexParameterf)(GLenum target, GLenum pname, GLfloat param);
typedef void (*PROC_glTexParameterfv)(GLenum target, GLenum pname, const GLfloat * params);
typedef void (*PROC_glTexParameteri)(GLenum target, GLenum pname, GLint param);
typedef void (*PROC_glTexParameteriv)(GLenum target, GLenum pname, const GLint * params);
typedef void (*PROC_glTexImage1D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void * pixels);
typedef void (*PROC_glTexImage2D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void * pixels);
typedef void (*PROC_glDrawBuffer)(GLenum buf);
typedef void (*PROC_glClear)(GLbitfield mask);
typedef void (*PROC_glClearColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
typedef void (*PROC_glClearStencil)(GLint s);
typedef void (*PROC_glClearDepth)(GLdouble depth);
typedef void (*PROC_glStencilMask)(GLuint mask);
typedef void (*PROC_glColorMask)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
typedef void (*PROC_glDepthMask)(GLboolean flag);
typedef void (*PROC_glDisable)(GLenum cap);
typedef void (*PROC_glEnable)(GLenum cap);
typedef void (*PROC_glFinish)();
typedef void (*PROC_glFlush)();
typedef void (*PROC_glBlendFunc)(GLenum sfactor, GLenum dfactor);
typedef void (*PROC_glLogicOp)(GLenum opcode);
typedef void (*PROC_glStencilFunc)(GLenum func, GLint ref, GLuint mask);
typedef void (*PROC_glStencilOp)(GLenum fail, GLenum zfail, GLenum zpass);
typedef void (*PROC_glDepthFunc)(GLenum func);
typedef void (*PROC_glPixelStoref)(GLenum pname, GLfloat param);
typedef void (*PROC_glPixelStorei)(GLenum pname, GLint param);
typedef void (*PROC_glReadBuffer)(GLenum src);
typedef void (*PROC_glReadPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void * pixels);
typedef void (*PROC_glGetBooleanv)(GLenum pname, GLboolean * data);
typedef void (*PROC_glGetDoublev)(GLenum pname, GLdouble * data);
typedef GLenum (*PROC_glGetError)();
typedef void (*PROC_glGetFloatv)(GLenum pname, GLfloat * data);
typedef void (*PROC_glGetIntegerv)(GLenum pname, GLint * data);
typedef const GLubyte * (*PROC_glGetString)(GLenum name);
typedef void (*PROC_glGetTexImage)(GLenum target, GLint level, GLenum format, GLenum type, void * pixels);
typedef void (*PROC_glGetTexParameterfv)(GLenum target, GLenum pname, GLfloat * params);
typedef void (*PROC_glGetTexParameteriv)(GLenum target, GLenum pname, GLint * params);
typedef void (*PROC_glGetTexLevelParameterfv)(GLenum target, GLint level, GLenum pname, GLfloat * params);
typedef void (*PROC_glGetTexLevelParameteriv)(GLenum target, GLint level, GLenum pname, GLint * params);
typedef GLboolean (*PROC_glIsEnabled)(GLenum cap);
typedef void (*PROC_glDepthRange)(GLdouble n, GLdouble f);
typedef void (*PROC_glViewport)(GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (*PROC_glDrawArrays)(GLenum mode, GLint first, GLsizei count);
typedef void (*PROC_glDrawElements)(GLenum mode, GLsizei count, GLenum type, const void * indices);
typedef void (*PROC_glPolygonOffset)(GLfloat factor, GLfloat units);
typedef void (*PROC_glCopyTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border);
typedef void (*PROC_glCopyTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border);
typedef void (*PROC_glCopyTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
typedef void (*PROC_glCopyTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (*PROC_glTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void * pixels);
typedef void (*PROC_glTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void * pixels);
typedef void (*PROC_glBindTexture)(GLenum target, GLuint texture);
typedef void (*PROC_glDeleteTextures)(GLsizei n, const GLuint * textures);
typedef void (*PROC_glGenTextures)(GLsizei n, GLuint * textures);
typedef GLboolean (*PROC_glIsTexture)(GLuint texture);
typedef void (*PROC_glDrawRangeElements)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices);
typedef void (*PROC_glTexImage3D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void * pixels);
typedef void (*PROC_glTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void * pixels);
typedef void (*PROC_glCopyTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (*PROC_glActiveTexture)(GLenum texture);
typedef void (*PROC_glSampleCoverage)(GLfloat value, GLboolean invert);
typedef void (*PROC_glCompressedTexImage3D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data);
typedef void (*PROC_glCompressedTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void * data);
typedef void (*PROC_glCompressedTexImage1D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void * data);
typedef void (*PROC_glCompressedTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void * data);
typedef void (*PROC_glCompressedTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void * data);
typedef void (*PROC_glCompressedTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void * data);
typedef void (*PROC_glGetCompressedTexImage)(GLenum target, GLint level, void * img);
typedef void (*PROC_glBlendFuncSeparate)(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
typedef void (*PROC_glMultiDrawArrays)(GLenum mode, const GLint * first, const GLsizei * count, GLsizei drawcount);
typedef void (*PROC_glMultiDrawElements)(GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei drawcount);
typedef void (*PROC_glPointParameterf)(GLenum pname, GLfloat param);
typedef void (*PROC_glPointParameterfv)(GLenum pname, const GLfloat * params);
typedef void (*PROC_glPointParameteri)(GLenum pname, GLint param);
typedef void (*PROC_glPointParameteriv)(GLenum pname, const GLint * params);
typedef void (*PROC_glBlendColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
typedef void (*PROC_glBlendEquation)(GLenum mode);
typedef void (*PROC_glGenQueries)(GLsizei n, GLuint * ids);
typedef void (*PROC_glDeleteQueries)(GLsizei n, const GLuint * ids);
typedef GLboolean (*PROC_glIsQuery)(GLuint id);
typedef void (*PROC_glBeginQuery)(GLenum target, GLuint id);
typedef void (*PROC_glEndQuery)(GLenum target);
typedef void (*PROC_glGetQueryiv)(GLenum target, GLenum pname, GLint * params);
typedef void (*PROC_glGetQueryObjectiv)(GLuint id, GLenum pname, GLint * params);
typedef void (*PROC_glGetQueryObjectuiv)(GLuint id, GLenum pname, GLuint * params);
typedef void (*PROC_glBindBuffer)(GLenum target, GLuint buffer);
typedef void (*PROC_glDeleteBuffers)(GLsizei n, const GLuint * buffers);
typedef void (*PROC_glGenBuffers)(GLsizei n, GLuint * buffers);
typedef GLboolean (*PROC_glIsBuffer)(GLuint buffer);
typedef void (*PROC_glBufferData)(GLenum target, GLsizeiptr size, const void * data, GLenum usage);
typedef void (*PROC_glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const void * data);
typedef void (*PROC_glGetBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, void * data);
typedef void * (*PROC_glMapBuffer)(GLenum target, GLenum access);
typedef GLboolean (*PROC_glUnmapBuffer)(GLenum target);
typedef void (*PROC_glGetBufferParameteriv)(GLenum target, GLenum pname, GLint * params);
typedef void (*PROC_glGetBufferPointerv)(GLenum target, GLenum pname, void ** params);
typedef void (*PROC_glBlendEquationSeparate)(GLenum modeRGB, GLenum modeAlpha);
typedef void (*PROC_glDrawBuffers)(GLsizei n, const GLenum * bufs);
typedef void (*PROC_glStencilOpSeparate)(GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass);
typedef void (*PROC_glStencilFuncSeparate)(GLenum face, GLenum func, GLint ref, GLuint mask);
typedef void (*PROC_glStencilMaskSeparate)(GLenum face, GLuint mask);
typedef void (*PROC_glAttachShader)(GLuint program, GLuint shader);
typedef void (*PROC_glBindAttribLocation)(GLuint program, GLuint index, const GLchar * name);
...
typedef void (*PROC_glDeleteProgram)(GLuint program);
typedef void (*PROC_glDeleteShader)(GLuint shader);
typedef void (*PROC_glDetachShader)(GLuint program, GLuint shader);
typedef void (*PROC_glDisableVertexAttribArray)(GLuint index);
typedef void (*PROC_glEnableVertexAttribArray)(GLuint index);
typedef void (*PROC_glGetActiveAttrib)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
typedef void (*PROC_glGetActiveUniform)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
typedef void (*PROC_glGetAttachedShaders)(GLuint program, GLsizei maxCount, GLsizei * count, GLuint * shaders);
typedef GLint (*PROC_glGetAttribLocation)(GLuint program, const GLchar * name);
typedef void (*PROC_glGetProgramiv)(GLuint program, GLenum pname, GLint * params);
typedef void (*PROC_glGetProgramInfoLog)(GLuint program, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
typedef void (*PROC_glGetShaderiv)(GLuint shader, GLenum pname, GLint * params);
typedef void (*PROC_glGetShaderInfoLog)(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
typedef void (*PROC_glGetShaderSource)(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * source);
typedef GLint (*PROC_glGetUniformLocation)(GLuint program, const GLchar * name);
typedef void (*PROC_glGetUniformfv)(GLuint program, GLint location, GLfloat * params);
typedef void (*PROC_glGetUniformiv)(GLuint program, GLint location, GLint * params);
typedef void (*PROC_glGetVertexAttribdv)(GLuint index, GLenum pname, GLdouble * params);
typedef void (*PROC_glGetVertexAttribfv)(GLuint index, GLenum pname, GLfloat * params);
typedef void (*PROC_glGetVertexAttribiv)(GLuint index, GLenum pname, GLint * params);
typedef void (*PROC_glGetVertexAttribPointerv)(GLuint index, GLenum pname, void ** pointer);
typedef GLboolean (*PROC_glIsProgram)(GLuint program);
typedef GLboolean (*PROC_glIsShader)(GLuint shader);
typedef void (*PROC_glLinkProgram)(GLuint program);
typedef void (*PROC_glShaderSource)(GLuint shader, GLsizei count, const GLchar *const* string, const GLint * length);
...
typedef void (*PROC_glValidateProgram)(GLuint program);
typedef void (*PROC_glVertexAttrib1d)(GLuint index, GLdouble x);
typedef void (*PROC_glVertexAttrib1dv)(GLuint index, const GLdouble * v);
typedef void (*PROC_glVertexAttrib1f)(GLuint index, GLfloat x);
typedef void (*PROC_glVertexAttrib1fv)(GLuint index, const GLfloat * v);
typedef void (*PROC_glVertexAttrib1s)(GLuint index, GLshort x);
typedef void (*PROC_glVertexAttrib1sv)(GLuint index, const GLshort * v);
typedef void (*PROC_glVertexAttrib2d)(GLuint index, GLdouble x, GLdouble y);
typedef void (*PROC_glVertexAttrib2dv)(GLuint index, const GLdouble * v);
typedef void (*PROC_glVertexAttrib2f)(GLuint index, GLfloat x, GLfloat y);
typedef void (*PROC_glVertexAttrib2fv)(GLuint index, const GLfloat * v);
typedef void (*PROC_glVertexAttrib2s)(GLuint index, GLshort x, GLshort y);
typedef void (*PROC_glVertexAttrib2sv)(GLuint index, const GLshort * v);
typedef void (*PROC_glVertexAttrib3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
typedef void (*PROC_glVertexAttrib3dv)(GLuint index, const GLdouble * v);
typedef void (*PROC_glVertexAttrib3f)(GLuint index, GLfloat x, GLfloat y, GLfloat z);
typedef void (*PROC_glVertexAttrib3fv)(GLuint index, const GLfloat * v);
typedef void (*PROC_glVertexAttrib3s)(GLuint index, GLshort x, GLshort y, GLshort z);
typedef void (*PROC_glVertexAttrib3sv)(GLuint index, const GLshort * v);
typedef void (*PROC_glVertexAttrib4Nbv)(GLuint index, const GLbyte * v);
typedef void (*PROC_glVertexAttrib4Niv)(GLuint index, const GLint * v);
typedef void (*PROC_glVertexAttrib4Nsv)(GLuint index, const GLshort * v);
typedef void (*PROC_glVertexAttrib4Nub)(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
typedef void (*PROC_glVertexAttrib4Nubv)(GLuint index, const GLubyte * v);
typedef void (*PROC_glVertexAttrib4Nuiv)(GLuint index, const GLuint * v);
typedef void (*PROC_glVertexAttrib4Nusv)(GLuint index, const GLushort * v);
typedef void (*PROC_glVertexAttrib4bv)(GLuint index, const GLbyte * v);
typedef void (*PROC_glVertexAttrib4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef void (*PROC_glVertexAttrib4dv)(GLuint index, const GLdouble * v);
typedef void (*PROC_glVertexAttrib4f)(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef void (*PROC_glVertexAttrib4fv)(GLuint index, const GLfloat * v);
typedef void (*PROC_glVertexAttrib4iv)(GLuint index, const GLint * v);
typedef void (*PROC_glVertexAttrib4s)(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
typedef void (*PROC_glVertexAttrib4sv)(GLuint index, const GLshort * v);
typedef void (*PROC_glVertexAttrib4ubv)(GLuint index, const GLubyte * v);
typedef void (*PROC_glVertexAttrib4uiv)(GLuint index, const GLuint * v);
typedef void (*PROC_glVertexAttrib4usv)(GLuint index, const GLushort * v);
typedef void (*PROC_glVertexAttribPointer)(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void * pointer);
...
typedef void (*PROC_glColorMaski)(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
typedef void (*PROC_glGetBooleani_v)(GLenum target, GLuint index, GLboolean * data);
typedef void (*PROC_glGetIntegeri_v)(GLenum target, GLuint index, GLint * data);
typedef void (*PROC_glEnablei)(GLenum target, GLuint index);
typedef void (*PROC_glDisablei)(GLenum target, GLuint index);
typedef GLboolean (*PROC_glIsEnabledi)(GLenum target, GLuint index);
typedef void (*PROC_glBeginTransformFeedback)(GLenum primitiveMode);
typedef void (*PROC_glEndTransformFeedback)();
typedef void (*PROC_glBindBufferRange)(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
typedef void (*PROC_glBindBufferBase)(GLenum target, GLuint index, GLuint buffer);
typedef void (*PROC_glTransformFeedbackVaryings)(GLuint program, GLsizei count, const GLchar *const* varyings, GLenum bufferMode);
typedef void (*PROC_glGetTransformFeedbackVarying)(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLsizei * size, GLenum * type, GLchar * name);
typedef void (*PROC_glClampColor)(GLenum target, GLenum clamp);
typedef void (*PROC_glBeginConditionalRender)(GLuint id, GLenum mode);
typedef void (*PROC_glEndConditionalRender)();
typedef void (*PROC_glVertexAttribIPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const void * pointer);
typedef void (*PROC_glGetVertexAttribIiv)(GLuint index, GLenum pname, GLint * params);
typedef void (*PROC_glGetVertexAttribIuiv)(GLuint index, GLenum pname, GLuint * params);
typedef void (*PROC_glVertexAttribI1i)(GLuint index, GLint x);
typedef void (*PROC_glVertexAttribI2i)(GLuint index, GLint x, GLint y);
typedef void (*PROC_glVertexAttribI3i)(GLuint index, GLint x, GLint y, GLint z);
typedef void (*PROC_glVertexAttribI4i)(GLuint index, GLint x, GLint y, GLint z, GLint w);
typedef void (*PROC_glVertexAttribI1ui)(GLuint index, GLuint x);
typedef void (*PROC_glVertexAttribI2ui)(GLuint index, GLuint x, GLuint y);
typedef void (*PROC_glVertexAttribI3ui)(GLuint index, GLuint x, GLuint y, GLuint z);
typedef void (*PROC_glVertexAttribI4ui)(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
typedef void (*PROC_glVertexAttribI1iv)(GLuint index, const GLint * v);
typedef void (*PROC_glVertexAttribI2iv)(GLuint index, const GLint * v);
typedef void (*PROC_glVertexAttribI3iv)(GLuint index, const GLint * v);
typedef void (*PROC_glVertexAttribI4iv)(GLuint index, const GLint * v);
typedef void (*PROC_glVertexAttribI1uiv)(GLuint index, const GLuint * v);
typedef void (*PROC_glVertexAttribI2uiv)(GLuint index, const GLuint * v);
typedef void (*PROC_glVertexAttribI3uiv)(GLuint index, const GLuint * v);
typedef void (*PROC_glVertexAttribI4uiv)(GLuint index, const GLuint * v);
typedef void (*PROC_glVertexAttribI4bv)(GLuint index, const GLbyte * v);
typedef void (*PROC_glVertexAttribI4sv)(GLuint index, const GLshort * v);
typedef void (*PROC_glVertexAttribI4ubv)(GLuint index, const GLubyte * v);
typedef void (*PROC_glVertexAttribI4usv)(GLuint index, const GLushort * v);
typedef void (*PROC_glGetUniformuiv)(GLuint program, GLint location, GLuint * params);
typedef void (*PROC_glBindFragDataLocation)(GLuint program, GLuint color, const GLchar * name);
typedef GLint (*PROC_glGetFragDataLocation)(GLuint program, const GLchar * name);
typedef void (*PROC_glUniform1ui)(GLint location, GLuint v0);
typedef void (*PROC_glUniform2ui)(GLint location, GLuint v0, GLuint v1);
typedef void (*PROC_glUniform3ui)(GLint location, GLuint v0, GLuint v1, GLuint v2);
typedef void (*PROC_glUniform4ui)(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
typedef void (*PROC_glUniform1uiv)(GLint location, GLsizei count, const GLuint * value);
typedef void (*PROC_glUniform2uiv)(GLint location, GLsizei count, const GLuint * value);
typedef void (*PROC_glUniform3uiv)(GLint location, GLsizei count, const GLuint * value);
typedef void (*PROC_glUniform4uiv)(GLint location, GLsizei count, const GLuint * value);
typedef void (*PROC_glTexParameterIiv)(GLenum target, GLenum pname, const GLint * params);
typedef void (*PROC_glTexParameterIuiv)(GLenum target, GLenum pname, const GLuint * params);
typedef void (*PROC_glGetTexParameterIiv)(GLenum target, GLenum pname, GLint * params);
typedef void (*PROC_glGetTexParameterIuiv)(GLenum target, GLenum pname, GLuint * params);
typedef void (*PROC_glClearBufferiv)(GLenum buffer, GLint drawbuffer, const GLint * value);
typedef void (*PROC_glClearBufferuiv)(GLenum buffer, GLint drawbuffer, const GLuint * value);
typedef void (*PROC_glClearBufferfv)(GLenum buffer, GLint drawbuffer, const GLfloat * value);
typedef void (*PROC_glClearBufferfi)(GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
typedef const GLubyte * (*PROC_glGetStringi)(GLenum name, GLuint index);
typedef GLboolean (*PROC_glIsRenderbuffer)(GLuint renderbuffer);
typedef void (*PROC_glBindRenderbuffer)(GLenum target, GLuint renderbuffer);
typedef void (*PROC_glDeleteRenderbuffers)(GLsizei n, const GLuint * renderbuffers);
typedef void (*PROC_glGenRenderbuffers)(GLsizei n, GLuint * renderbuffers);
typedef void (*PROC_glRenderbufferStorage)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
typedef void (*PROC_glGetRenderbufferParameteriv)(GLenum target, GLenum pname, GLint * params);
typedef GLboolean (*PROC_glIsFramebuffer)(GLuint framebuffer);
typedef void (*PROC_glBindFramebuffer)(GLenum target, GLuint framebuffer);
typedef void (*PROC_glDeleteFramebuffers)(GLsizei n, const GLuint * framebuffers);
typedef void (*PROC_glGenFramebuffers)(GLsizei n, GLuint * framebuffers);
typedef GLenum (*PROC_glCheckFramebufferStatus)(GLenum target);
typedef void (*PROC_glFramebufferTexture1D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
typedef void (*PROC_glFramebufferTexture2D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
typedef void (*PROC_glFramebufferTexture3D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
typedef void (*PROC_glFramebufferRenderbuffer)(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
typedef void (*PROC_glGetFramebufferAttachmentParameteriv)(GLenum target, GLenum attachment, GLenum pname, GLint * params);
typedef void (*PROC_glGenerateMipmap)(GLenum target);
typedef void (*PROC_glBlitFramebuffer)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
typedef void (*PROC_glRenderbufferStorageMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
typedef void (*PROC_glFramebufferTextureLayer)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
typedef void * (*PROC_glMapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
typedef void (*PROC_glFlushMappedBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length);
typedef void (*PROC_glBindVertexArray)(GLuint array);
typedef void (*PROC_glDeleteVertexArrays)(GLsizei n, const GLuint * arrays);
typedef void (*PROC_glGenVertexArrays)(GLsizei n, GLuint * arrays);
typedef GLboolean (*PROC_glIsVertexArray)(GLuint array);
typedef void (*PROC_glDrawArraysInstanced)(GLenum mode, GLint first, GLsizei count, GLsizei instancecount);
typedef void (*PROC_glDrawElementsInstanced)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount);
typedef void (*PROC_glTexBuffer)(GLenum target, GLenum internalformat, GLuint buffer);
typedef void (*PROC_glPrimitiveRestartIndex)(GLuint index);
typedef void (*PROC_glCopyBufferSubData)(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
typedef void (*PROC_glGetUniformIndices)(GLuint program, GLsizei uniformCount, const GLchar *const* uniformNames, GLuint * uniformIndices);
typedef void (*PROC_glGetActiveUniformsiv)(GLuint program, GLsizei uniformCount, const GLuint * uniformIndices, GLenum pname, GLint * params);
typedef void (*PROC_glGetActiveUniformName)(GLuint program, GLuint uniformIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformName);
typedef GLuint (*PROC_glGetUniformBlockIndex)(GLuint program, const GLchar * uniformBlockName);
typedef void (*PROC_glGetActiveUniformBlockiv)(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint * params);
typedef void (*PROC_glGetActiveUniformBlockName)(GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformBlockName);
typedef void (*PROC_glUniformBlockBinding)(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);
typedef void (*PROC_glDrawElementsBaseVertex)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLint basevertex);
typedef void (*PROC_glDrawRangeElementsBaseVertex)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices, GLint basevertex);
typedef void (*PROC_glDrawElementsInstancedBaseVertex)(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLint basevertex);
typedef void (*PROC_glMultiDrawElementsBaseVertex)(GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei drawcount, const GLint * basevertex);
typedef void (*PROC_glProvokingVertex)(GLenum mode);
typedef GLsync (*PROC_glFenceSync)(GLenum condition, GLbitfield flags);
typedef GLboolean (*PROC_glIsSync)(GLsync sync);
typedef void (*PROC_glDeleteSync)(GLsync sync);
typedef GLenum (*PROC_glClientWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
typedef void (*PROC_glWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
typedef void (*PROC_glGetInteger64v)(GLenum pname, GLint64 * data);
typedef void (*PROC_glGetSynciv)(GLsync sync, GLenum pname, GLsizei count, GLsizei * length, GLint * values);
typedef void (*PROC_glGetInteger64i_v)(GLenum target, GLuint index, GLint64 * data);
typedef void (*PROC_glGetBufferParameteri64v)(GLenum target, GLenum pname, GLint64 * params);
typedef void (*PROC_glFramebufferTexture)(GLenum target, GLenum attachment, GLuint texture, GLint level);
typedef void (*PROC_glTexImage2DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
typedef void (*PROC_glTexImage3DMultisample)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
typedef void (*PROC_glGetMultisamplefv)(GLenum pname, GLuint index, GLfloat * val);
typedef void (*PROC_glSampleMaski)(GLuint maskNumber, GLbitfield mask);
typedef void (*PROC_glBindFragDataLocationIndexed)(GLuint program, GLuint colorNumber, GLuint index, const GLchar * name);
typedef GLint (*PROC_glGetFragDataIndex)(GLuint program, const GLchar * name);
typedef void (*PROC_glGenSamplers)(GLsizei count, GLuint * samplers);
typedef void (*PROC_glDeleteSamplers)(GLsizei count, const GLuint * samplers);
typedef GLboolean (*PROC_glIsSampler)(GLuint sampler);
typedef void (*PROC_glBindSampler)(GLuint unit, GLuint sampler);
typedef void (*PROC_glSamplerParameteri)(GLuint sampler, GLenum pname, GLint param);
typedef void (*PROC_glSamplerParameteriv)(GLuint sampler, GLenum pname, const GLint * param);
typedef void (*PROC_glSamplerParameterf)(GLuint sampler, GLenum pname, GLfloat param);
typedef void (*PROC_glSamplerParameterfv)(GLuint sampler, GLenum pname, const GLfloat * param);
typedef void (*PROC_glSamplerParameterIiv)(GLuint sampler, GLenum pname, const GLint * param);
typedef void (*PROC_glSamplerParameterIuiv)(GLuint sampler, GLenum pname, const GLuint * param);
typedef void (*PROC_glGetSamplerParameteriv)(GLuint sampler, GLenum pname, GLint * params);
typedef void (*PROC_glGetSamplerParameterIiv)(GLuint sampler, GLenum pname, GLint * params);
typedef void (*PROC_glGetSamplerParameterfv)(GLuint sampler, GLenum pname, GLfloat * params);
typedef void (*PROC_glGetSamplerParameterIuiv)(GLuint sampler, GLenum pname, GLuint * params);
typedef void (*PROC_glQueryCounter)(GLuint id, GLenum target);
typedef void (*PROC_glGetQueryObjecti64v)(GLuint id, GLenum pname, GLint64 * params);
typedef void (*PROC_glGetQueryObjectui64v)(GLuint id, GLenum pname, GLuint64 * params);
typedef void (*PROC_glVertexAttribDivisor)(GLuint index, GLuint divisor);
typedef void (*PROC_glVertexAttribP1ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
typedef void (*PROC_glVertexAttribP1uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
typedef void (*PROC_glVertexAttribP2ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
typedef void (*PROC_glVertexAttribP2uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
typedef void (*PROC_glVertexAttribP3ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
typedef void (*PROC_glVertexAttribP3uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
typedef void (*PROC_glVertexAttribP4ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
typedef void (*PROC_glVertexAttribP4uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint * value);
typedef void (*PROC_glVertexP2ui)(GLenum type, GLuint value);
typedef void (*PROC_glVertexP2uiv)(GLenum type, const GLuint * value);
typedef void (*PROC_glVertexP3ui)(GLenum type, GLuint value);
typedef void (*PROC_glVertexP3uiv)(GLenum type, const GLuint * value);
typedef void (*PROC_glVertexP4ui)(GLenum type, GLuint value);
typedef void (*PROC_glVertexP4uiv)(GLenum type, const GLuint * value);
typedef void (*PROC_glTexCoordP1ui)(GLenum type, GLuint coords);
typedef void (*PROC_glTexCoordP1uiv)(GLenum type, const GLuint * coords);
typedef void (*PROC_glTexCoordP2ui)(GLenum type, GLuint coords);
typedef void (*PROC_glTexCoordP2uiv)(GLenum type, const GLuint * coords);
typedef void (*PROC_glTexCoordP3ui)(GLenum type, GLuint coords);
typedef void (*PROC_glTexCoordP3uiv)(GLenum type, const GLuint * coords);
typedef void (*PROC_glTexCoordP4ui)(GLenum type, GLuint coords);
typedef void (*PROC_glTexCoordP4uiv)(GLenum type, const GLuint * coords);
typedef void (*PROC_glMultiTexCoordP1ui)(GLenum texture, GLenum type, GLuint coords);
typedef void (*PROC_glMultiTexCoordP1uiv)(GLenum texture, GLenum type, const GLuint * coords);
typedef void (*PROC_glMultiTexCoordP2ui)(GLenum texture, GLenum type, GLuint coords);
typedef void (*PROC_glMultiTexCoordP2uiv)(GLenum texture, GLenum type, const GLuint * coords);
typedef void (*PROC_glMultiTexCoordP3ui)(GLenum texture, GLenum type, GLuint coords);
typedef void (*PROC_glMultiTexCoordP3uiv)(GLenum texture, GLenum type, const GLuint * coords);
typedef void (*PROC_glMultiTexCoordP4ui)(GLenum texture, GLenum type, GLuint coords);
typedef void (*PROC_glMultiTexCoordP4uiv)(GLenum texture, GLenum type, const GLuint * coords);
typedef void (*PROC_glNormalP3ui)(GLenum type, GLuint coords);
typedef void (*PROC_glNormalP3uiv)(GLenum type, const GLuint * coords);
typedef void (*PROC_glColorP3ui)(GLenum type, GLuint color);
typedef void (*PROC_glColorP3uiv)(GLenum type, const GLuint * color);
typedef void (*PROC_glColorP4ui)(GLenum type, GLuint color);
typedef void (*PROC_glColorP4uiv)(GLenum type, const GLuint * color);
typedef void (*PROC_glSecondaryColorP3ui)(GLenum type, GLuint color);
typedef void (*PROC_glSecondaryColorP3uiv)(GLenum type, const GLuint * color);
typedef void (*PROC_glDebugMessageControl)(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled);
typedef void (*PROC_glDebugMessageInsert)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar * buf);
typedef void (*PROC_glDebugMessageCallback)(GLDEBUGPROC callback, const void * userParam);
typedef GLuint (*PROC_glGetDebugMessageLog)(GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * severities, GLsizei * lengths, GLchar * messageLog);
typedef void (*PROC_glPushDebugGroup)(GLenum source, GLuint id, GLsizei length, const GLchar * message);
typedef void (*PROC_glPopDebugGroup)();
typedef void (*PROC_glObjectLabel)(GLenum identifier, GLuint name, GLsizei length, const GLchar * label);
typedef void (*PROC_glGetObjectLabel)(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei * length, GLchar * label);
typedef void (*PROC_glObjectPtrLabel)(const void * ptr, GLsizei length, const GLchar * label);
typedef void (*PROC_glGetObjectPtrLabel)(const void * ptr, GLsizei bufSize, GLsizei * length, GLchar * label);
typedef void (*PROC_glGetPointerv)(GLenum pname, void ** params);

PROC_glCullFace glCullFace = 0;
PROC_glFrontFace glFrontFace = 0;
PROC_glHint glHint = 0;
PROC_glLineWidth glLineWidth = 0;
PROC_glPointSize glPointSize = 0;
PROC_glPolygonMode glPolygonMode = 0;
PROC_glScissor glScissor = 0;
PROC_glTexParameterf glTexParameterf = 0;
PROC_glTexParameterfv glTexParameterfv = 0;
PROC_glTexParameteri glTexParameteri = 0;
PROC_glTexParameteriv glTexParameteriv = 0;
PROC_glTexImage1D glTexImage1D = 0;
PROC_glTexImage2D glTexImage2D = 0;
PROC_glDrawBuffer glDrawBuffer = 0;
PROC_glClear glClear = 0;
PROC_glClearColor glClearColor = 0;
PROC_glClearStencil glClearStencil = 0;
PROC_glClearDepth glClearDepth = 0;
PROC_glStencilMask glStencilMask = 0;
PROC_glColorMask glColorMask = 0;
PROC_glDepthMask glDepthMask = 0;
PROC_glDisable glDisable = 0;
PROC_glEnable glEnable = 0;
PROC_glFinish glFinish = 0;
PROC_glFlush glFlush = 0;
PROC_glBlendFunc glBlendFunc = 0;
PROC_glLogicOp glLogicOp = 0;
PROC_glStencilFunc glStencilFunc = 0;
PROC_glStencilOp glStencilOp = 0;
PROC_glDepthFunc glDepthFunc = 0;
PROC_glPixelStoref glPixelStoref = 0;
PROC_glPixelStorei glPixelStorei = 0;
PROC_glReadBuffer glReadBuffer = 0;
PROC_glReadPixels glReadPixels = 0;
PROC_glGetBooleanv glGetBooleanv = 0;
PROC_glGetDoublev glGetDoublev = 0;
PROC_glGetError glGetError = 0;
PROC_glGetFloatv glGetFloatv = 0;
PROC_glGetIntegerv glGetIntegerv = 0;
PROC_glGetString glGetString = 0;
PROC_glGetTexImage glGetTexImage = 0;
PROC_glGetTexParameterfv glGetTexParameterfv = 0;
PROC_glGetTexParameteriv glGetTexParameteriv = 0;
PROC_glGetTexLevelParameterfv glGetTexLevelParameterfv = 0;
PROC_glGetTexLevelParameteriv glGetTexLevelParameteriv = 0;
PROC_glIsEnabled glIsEnabled = 0;
PROC_glDepthRange glDepthRange = 0;
PROC_glViewport glViewport = 0;
PROC_glDrawArrays glDrawArrays = 0;
PROC_glDrawElements glDrawElements = 0;
PROC_glPolygonOffset glPolygonOffset = 0;
PROC_glCopyTexImage1D glCopyTexImage1D = 0;
PROC_glCopyTexImage2D glCopyTexImage2D = 0;
PROC_glCopyTexSubImage1D glCopyTexSubImage1D = 0;
PROC_glCopyTexSubImage2D glCopyTexSubImage2D = 0;
PROC_glTexSubImage1D glTexSubImage1D = 0;
PROC_glTexSubImage2D glTexSubImage2D = 0;
PROC_glBindTexture glBindTexture = 0;
PROC_glDeleteTextures glDeleteTextures = 0;
PROC_glGenTextures glGenTextures = 0;
PROC_glIsTexture glIsTexture = 0;
PROC_glDrawRangeElements glDrawRangeElements = 0;
PROC_glTexImage3D glTexImage3D = 0;
PROC_glTexSubImage3D glTexSubImage3D = 0;
PROC_glCopyTexSubImage3D glCopyTexSubImage3D = 0;
PROC_glActiveTexture glActiveTexture = 0;
PROC_glSampleCoverage glSampleCoverage = 0;
PROC_glCompressedTexImage3D glCompressedTexImage3D = 0;
PROC_glCompressedTexImage2D glCompressedTexImage2D = 0;
PROC_glCompressedTexImage1D glCompressedTexImage1D = 0;
PROC_glCompressedTexSubImage3D glCompressedTexSubImage3D = 0;
PROC_glCompressedTexSubImage2D glCompressedTexSubImage2D = 0;
PROC_glCompressedTexSubImage1D glCompressedTexSubImage1D = 0;
PROC_glGetCompressedTexImage glGetCompressedTexImage = 0;
PROC_glBlendFuncSeparate glBlendFuncSeparate = 0;
PROC_glMultiDrawArrays glMultiDrawArrays = 0;
PROC_glMultiDrawElements glMultiDrawElements = 0;
PROC_glPointParameterf glPointParameterf = 0;
PROC_glPointParameterfv glPointParameterfv = 0;
PROC_glPointParameteri glPointParameteri = 0;
PROC_glPointParameteriv glPointParameteriv = 0;
PROC_glBlendColor glBlendColor = 0;
PROC_glBlendEquation glBlendEquation = 0;
PROC_glGenQueries glGenQueries = 0;
PROC_glDeleteQueries glDeleteQueries = 0;
PROC_glIsQuery glIsQuery = 0;
PROC_glBeginQuery glBeginQuery = 0;
PROC_glEndQuery glEndQuery = 0;
PROC_glGetQueryiv glGetQueryiv = 0;
PROC_glGetQueryObjectiv glGetQueryObjectiv = 0;
PROC_glGetQueryObjectuiv glGetQueryObjectuiv = 0;
PROC_glBindBuffer glBindBuffer = 0;
PROC_glDeleteBuffers glDeleteBuffers = 0;
PROC_glGenBuffers glGenBuffers = 0;
PROC_glIsBuffer glIsBuffer = 0;
PROC_glBufferData glBufferData = 0;
PROC_glBufferSubData glBufferSubData = 0;
PROC_glGetBufferSubData glGetBufferSubData = 0;
PROC_glMapBuffer glMapBuffer = 0;
PROC_glUnmapBuffer glUnmapBuffer = 0;
PROC_glGetBufferParameteriv glGetBufferParameteriv = 0;
PROC_glGetBufferPointerv glGetBufferPointerv = 0;
PROC_glBlendEquationSeparate glBlendEquationSeparate = 0;
PROC_glDrawBuffers glDrawBuffers = 0;
PROC_glStencilOpSeparate glStencilOpSeparate = 0;
PROC_glStencilFuncSeparate glStencilFuncSeparate = 0;
PROC_glStencilMaskSeparate glStencilMaskSeparate = 0;
PROC_glAttachShader glAttachShader = 0;
PROC_glBindAttribLocation glBindAttribLocation = 0;
...
PROC_glDisableVertexAttribArray glDisableVertexAttribArray = 0;
PROC_glEnableVertexAttribArray glEnableVertexAttribArray = 0;
PROC_glGetActiveAttrib glGetActiveAttrib = 0;
PROC_glGetActiveUniform glGetActiveUniform = 0;
PROC_glGetAttachedShaders glGetAttachedShaders = 0;
PROC_glGetAttribLocation glGetAttribLocation = 0;
PROC_glGetProgramiv glGetProgramiv = 0;
PROC_glGetProgramInfoLog glGetProgramInfoLog = 0;
PROC_glGetShaderiv glGetShaderiv = 0;
PROC_glGetShaderInfoLog glGetShaderInfoLog = 0;
PROC_glGetShaderSource glGetShaderSource = 0;
PROC_glGetUniformLocation glGetUniformLocation = 0;
PROC_glGetUniformfv glGetUniformfv = 0;
PROC_glGetUniformiv glGetUniformiv = 0;
PROC_glGetVertexAttribdv glGetVertexAttribdv = 0;
PROC_glGetVertexAttribfv glGetVertexAttribfv = 0;
PROC_glGetVertexAttribiv glGetVertexAttribiv = 0;
PROC_glGetVertexAttribPointerv glGetVertexAttribPointerv = 0;
PROC_glIsProgram glIsProgram = 0;
PROC_glIsShader glIsShader = 0;
...
PROC_glValidateProgram glValidateProgram = 0;
PROC_glVertexAttrib1d glVertexAttrib1d = 0;
PROC_glVertexAttrib1dv glVertexAttrib1dv = 0;
PROC_glVertexAttrib1f glVertexAttrib1f = 0;
PROC_glVertexAttrib1fv glVertexAttrib1fv = 0;
PROC_glVertexAttrib1s glVertexAttrib1s = 0;
PROC_glVertexAttrib1sv glVertexAttrib1sv = 0;
PROC_glVertexAttrib2d glVertexAttrib2d = 0;
PROC_glVertexAttrib2dv glVertexAttrib2dv = 0;
PROC_glVertexAttrib2f glVertexAttrib2f = 0;
PROC_glVertexAttrib2fv glVertexAttrib2fv = 0;
PROC_glVertexAttrib2s glVertexAttrib2s = 0;
PROC_glVertexAttrib2sv glVertexAttrib2sv = 0;
PROC_glVertexAttrib3d glVertexAttrib3d = 0;
PROC_glVertexAttrib3dv glVertexAttrib3dv = 0;
PROC_glVertexAttrib3f glVertexAttrib3f = 0;
PROC_glVertexAttrib3fv glVertexAttrib3fv = 0;
PROC_glVertexAttrib3s glVertexAttrib3s = 0;
PROC_glVertexAttrib3sv glVertexAttrib3sv = 0;
PROC_glVertexAttrib4Nbv glVertexAttrib4Nbv = 0;
PROC_glVertexAttrib4Niv glVertexAttrib4Niv = 0;
PROC_glVertexAttrib4Nsv glVertexAttrib4Nsv = 0;
PROC_glVertexAttrib4Nub glVertexAttrib4Nub = 0;
PROC_glVertexAttrib4Nubv glVertexAttrib4Nubv = 0;
PROC_glVertexAttrib4Nuiv glVertexAttrib4Nuiv = 0;
PROC_glVertexAttrib4Nusv glVertexAttrib4Nusv = 0;
PROC_glVertexAttrib4bv glVertexAttrib4bv = 0;
PROC_glVertexAttrib4d glVertexAttrib4d = 0;
PROC_glVertexAttrib4dv glVertexAttrib4dv = 0;
PROC_glVertexAttrib4f glVertexAttrib4f = 0;
PROC_glVertexAttrib4fv glVertexAttrib4fv = 0;
PROC_glVertexAttrib4iv glVertexAttrib4iv = 0;
PROC_glVertexAttrib4s glVertexAttrib4s = 0;
PROC_glVertexAttrib4sv glVertexAttrib4sv = 0;
PROC_glVertexAttrib4ubv glVertexAttrib4ubv = 0;
PROC_glVertexAttrib4uiv glVertexAttrib4uiv = 0;
PROC_glVertexAttrib4usv glVertexAttrib4usv = 0;
PROC_glVertexAttribPointer glVertexAttribPointer = 0;
...
PROC_glColorMaski glColorMaski = 0;
PROC_glGetBooleani_v glGetBooleani_v = 0;
PROC_glGetIntegeri_v glGetIntegeri_v = 0;
PROC_glEnablei glEnablei = 0;
PROC_glDisablei glDisablei = 0;
PROC_glIsEnabledi glIsEnabledi = 0;
PROC_glBeginTransformFeedback glBeginTransformFeedback = 0;
PROC_glEndTransformFeedback glEndTransformFeedback = 0;
PROC_glBindBufferRange glBindBufferRange = 0;
PROC_glBindBufferBase glBindBufferBase = 0;
PROC_glTransformFeedbackVaryings glTransformFeedbackVaryings = 0;
PROC_glGetTransformFeedbackVarying glGetTransformFeedbackVarying = 0;
PROC_glClampColor glClampColor = 0;
PROC_glBeginConditionalRender glBeginConditionalRender = 0;
PROC_glEndConditionalRender glEndConditionalRender = 0;
PROC_glVertexAttribIPointer glVertexAttribIPointer = 0;
PROC_glGetVertexAttribIiv glGetVertexAttribIiv = 0;
PROC_glGetVertexAttribIuiv glGetVertexAttribIuiv = 0;
PROC_glVertexAttribI1i glVertexAttribI1i = 0;
PROC_glVertexAttribI2i glVertexAttribI2i = 0;
PROC_glVertexAttribI3i glVertexAttribI3i = 0;
PROC_glVertexAttribI4i glVertexAttribI4i = 0;
PROC_glVertexAttribI1ui glVertexAttribI1ui = 0;
PROC_glVertexAttribI2ui glVertexAttribI2ui = 0;
PROC_glVertexAttribI3ui glVertexAttribI3ui = 0;
PROC_glVertexAttribI4ui glVertexAttribI4ui = 0;
PROC_glVertexAttribI1iv glVertexAttribI1iv = 0;
PROC_glVertexAttribI2iv glVertexAttribI2iv = 0;
PROC_glVertexAttribI3iv glVertexAttribI3iv = 0;
PROC_glVertexAttribI4iv glVertexAttribI4iv = 0;
PROC_glVertexAttribI1uiv glVertexAttribI1uiv = 0;
PROC_glVertexAttribI2uiv glVertexAttribI2uiv = 0;
PROC_glVertexAttribI3uiv glVertexAttribI3uiv = 0;
PROC_glVertexAttribI4uiv glVertexAttribI4uiv = 0;
PROC_glVertexAttribI4bv glVertexAttribI4bv = 0;
PROC_glVertexAttribI4sv glVertexAttribI4sv = 0;
PROC_glVertexAttribI4ubv glVertexAttribI4ubv = 0;
PROC_glVertexAttribI4usv glVertexAttribI4usv = 0;
PROC_glGetUniformuiv glGetUniformuiv = 0;
PROC_glBindFragDataLocation glBindFragDataLocation = 0;
PROC_glGetFragDataLocation glGetFragDataLocation = 0;
PROC_glUniform1ui glUniform1ui = 0;
PROC_glUniform2ui glUniform2ui = 0;
PROC_glUniform3ui glUniform3ui = 0;
PROC_glUniform4ui glUniform4ui = 0;
PROC_glUniform1uiv glUniform1uiv = 0;
PROC_glUniform2uiv glUniform2uiv = 0;
PROC_glUniform3uiv glUniform3uiv = 0;
PROC_glUniform4uiv glUniform4uiv = 0;
PROC_glTexParameterIiv glTexParameterIiv = 0;
PROC_glTexParameterIuiv glTexParameterIuiv = 0;
PROC_glGetTexParameterIiv glGetTexParameterIiv = 0;
PROC_glGetTexParameterIuiv glGetTexParameterIuiv = 0;
PROC_glClearBufferiv glClearBufferiv = 0;
PROC_glClearBufferuiv glClearBufferuiv = 0;
PROC_glClearBufferfv glClearBufferfv = 0;
PROC_glClearBufferfi glClearBufferfi = 0;
PROC_glGetStringi glGetStringi = 0;
PROC_glIsRenderbuffer glIsRenderbuffer = 0;
PROC_glBindRenderbuffer glBindRenderbuffer = 0;
PROC_glDeleteRenderbuffers glDeleteRenderbuffers = 0;
PROC_glGenRenderbuffers glGenRenderbuffers = 0;
PROC_glRenderbufferStorage glRenderbufferStorage = 0;
PROC_glGetRenderbufferParameteriv glGetRenderbufferParameteriv = 0;
PROC_glIsFramebuffer glIsFramebuffer = 0;
PROC_glBindFramebuffer glBindFramebuffer = 0;
PROC_glDeleteFramebuffers glDeleteFramebuffers = 0;
PROC_glGenFramebuffers glGenFramebuffers = 0;
PROC_glCheckFramebufferStatus glCheckFramebufferStatus = 0;
PROC_glFramebufferTexture1D glFramebufferTexture1D = 0;
PROC_glFramebufferTexture2D glFramebufferTexture2D = 0;
PROC_glFramebufferTexture3D glFramebufferTexture3D = 0;
PROC_glFramebufferRenderbuffer glFramebufferRenderbuffer = 0;
PROC_glGetFramebufferAttachmentParameteriv glGetFramebufferAttachmentParameteriv = 0;
PROC_glGenerateMipmap glGenerateMipmap = 0;
PROC_glBlitFramebuffer glBlitFramebuffer = 0;
PROC_glRenderbufferStorageMultisample glRenderbufferStorageMultisample = 0;
PROC_glFramebufferTextureLayer glFramebufferTextureLayer = 0;
PROC_glMapBufferRange glMapBufferRange = 0;
PROC_glFlushMappedBufferRange glFlushMappedBufferRange = 0;
PROC_glBindVertexArray glBindVertexArray = 0;
PROC_glDeleteVertexArrays glDeleteVertexArrays = 0;
PROC_glGenVertexArrays glGenVertexArrays = 0;
PROC_glIsVertexArray glIsVertexArray = 0;
PROC_glDrawArraysInstanced glDrawArraysInstanced = 0;
PROC_glDrawElementsInstanced glDrawElementsInstanced = 0;
PROC_glTexBuffer glTexBuffer = 0;
PROC_glPrimitiveRestartIndex glPrimitiveRestartIndex = 0;
PROC_glCopyBufferSubData glCopyBufferSubData = 0;
PROC_glGetUniformIndices glGetUniformIndices = 0;
PROC_glGetActiveUniformsiv glGetActiveUniformsiv = 0;
PROC_glGetActiveUniformName glGetActiveUniformName = 0;
PROC_glGetUniformBlockIndex glGetUniformBlockIndex = 0;
PROC_glGetActiveUniformBlockiv glGetActiveUniformBlockiv = 0;
PROC_glGetActiveUniformBlockName glGetActiveUniformBlockName = 0;
PROC_glUniformBlockBinding glUniformBlockBinding = 0;
PROC_glDrawElementsBaseVertex glDrawElementsBaseVertex = 0;
PROC_glDrawRangeElementsBaseVertex glDrawRangeElementsBaseVertex = 0;
PROC_glDrawElementsInstancedBaseVertex glDrawElementsInstancedBaseVertex = 0;
PROC_glMultiDrawElementsBaseVertex glMultiDrawElementsBaseVertex = 0;
PROC_glProvokingVertex glProvokingVertex = 0;
PROC_glFenceSync glFenceSync = 0;
PROC_glIsSync glIsSync = 0;
PROC_glDeleteSync glDeleteSync = 0;
PROC_glClientWaitSync glClientWaitSync = 0;
PROC_glWaitSync glWaitSync = 0;
PROC_glGetInteger64v glGetInteger64v = 0;
PROC_glGetSynciv glGetSynciv = 0;
PROC_glGetInteger64i_v glGetInteger64i_v = 0;
PROC_glGetBufferParameteri64v glGetBufferParameteri64v = 0;
PROC_glFramebufferTexture glFramebufferTexture = 0;
PROC_glTexImage2DMultisample glTexImage2DMultisample = 0;
PROC_glTexImage3DMultisample glTexImage3DMultisample = 0;
PROC_glGetMultisamplefv glGetMultisamplefv = 0;
PROC_glSampleMaski glSampleMaski = 0;
PROC_glBindFragDataLocationIndexed glBindFragDataLocationIndexed = 0;
PROC_glGetFragDataIndex glGetFragDataIndex = 0;
PROC_glGenSamplers glGenSamplers = 0;
PROC_glDeleteSamplers glDeleteSamplers = 0;
PROC_glIsSampler glIsSampler = 0;
PROC_glBindSampler glBindSampler = 0;
PROC_glSamplerParameteri glSamplerParameteri = 0;
PROC_glSamplerParameteriv glSamplerParameteriv = 0;
PROC_glSamplerParameterf glSamplerParameterf = 0;
PROC_glSamplerParameterfv glSamplerParameterfv = 0;
PROC_glSamplerParameterIiv glSamplerParameterIiv = 0;
PROC_glSamplerParameterIuiv glSamplerParameterIuiv = 0;
PROC_glGetSamplerParameteriv glGetSamplerParameteriv = 0;
PROC_glGetSamplerParameterIiv glGetSamplerParameterIiv = 0;
PROC_glGetSamplerParameterfv glGetSamplerParameterfv = 0;
PROC_glGetSamplerParameterIuiv glGetSamplerParameterIuiv = 0;
PROC_glQueryCounter glQueryCounter = 0;
PROC_glGetQueryObjecti64v glGetQueryObjecti64v = 0;
PROC_glGetQueryObjectui64v glGetQueryObjectui64v = 0;
PROC_glVertexAttribDivisor glVertexAttribDivisor = 0;
PROC_glVertexAttribP1ui glVertexAttribP1ui = 0;
PROC_glVertexAttribP1uiv glVertexAttribP1uiv = 0;
PROC_glVertexAttribP2ui glVertexAttribP2ui = 0;
PROC_glVertexAttribP2uiv glVertexAttribP2uiv = 0;
PROC_glVertexAttribP3ui glVertexAttribP3ui = 0;
PROC_glVertexAttribP3uiv glVertexAttribP3uiv = 0;
PROC_glVertexAttribP4ui glVertexAttribP4ui = 0;
PROC_glVertexAttribP4uiv glVertexAttribP4uiv = 0;
PROC_glVertexP2ui glVertexP2ui = 0;
PROC_glVertexP2uiv glVertexP2uiv = 0;
PROC_glVertexP3ui glVertexP3ui = 0;
PROC_glVertexP3uiv glVertexP3uiv = 0;
PROC_glVertexP4ui glVertexP4ui = 0;
PROC_glVertexP4uiv glVertexP4uiv = 0;
PROC_glTexCoordP1ui glTexCoordP1ui = 0;
PROC_glTexCoordP1uiv glTexCoordP1uiv = 0;
PROC_glTexCoordP2ui glTexCoordP2ui = 0;
PROC_glTexCoordP2uiv glTexCoordP2uiv = 0;
PROC_glTexCoordP3ui glTexCoordP3ui = 0;
PROC_glTexCoordP3uiv glTexCoordP3uiv = 0;
PROC_glTexCoordP4ui glTexCoordP4ui = 0;
PROC_glTexCoordP4uiv glTexCoordP4uiv = 0;
PROC_glMultiTexCoordP1ui glMultiTexCoordP1ui = 0;
PROC_glMultiTexCoordP1uiv glMultiTexCoordP1uiv = 0;
PROC_glMultiTexCoordP2ui glMultiTexCoordP2ui = 0;
PROC_glMultiTexCoordP2uiv glMultiTexCoordP2uiv = 0;
PROC_glMultiTexCoordP3ui glMultiTexCoordP3ui = 0;
PROC_glMultiTexCoordP3uiv glMultiTexCoordP3uiv = 0;
PROC_glMultiTexCoordP4ui glMultiTexCoordP4ui = 0;
PROC_glMultiTexCoordP4uiv glMultiTexCoordP4uiv = 0;
PROC_glNormalP3ui glNormalP3ui = 0;
PROC_glNormalP3uiv glNormalP3uiv = 0;
PROC_glColorP3ui glColorP3ui = 0;
PROC_glColorP3uiv glColorP3uiv = 0;
PROC_glColorP4ui glColorP4ui = 0;
PROC_glColorP4uiv glColorP4uiv = 0;
PROC_glSecondaryColorP3ui glSecondaryColorP3ui = 0;
PROC_glSecondaryColorP3uiv glSecondaryColorP3uiv = 0;
PROC_glDebugMessageControl glDebugMessageControl = 0;
PROC_glDebugMessageInsert glDebugMessageInsert = 0;
PROC_glDebugMessageCallback glDebugMessageCallback = 0;
PROC_glGetDebugMessageLog glGetDebugMessageLog = 0;
PROC_glPushDebugGroup glPushDebugGroup = 0;
PROC_glPopDebugGroup glPopDebugGroup = 0;
PROC_glObjectLabel glObjectLabel = 0;
PROC_glGetObjectLabel glGetObjectLabel = 0;
PROC_glObjectPtrLabel glObjectPtrLabel = 0;
PROC_glGetObjectPtrLabel glGetObjectPtrLabel = 0;
PROC_glGetPointerv glGetPointerv = 0;
